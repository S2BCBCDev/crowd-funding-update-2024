...
contract CrowdCollab { 
    ...
    function createRequest(string memory description, uint256 amount, address payable recipient) 
        public managerOnly {
    ...
    function finalizeRequest(uint256 requestId) public managerOnly {
        ...
        require(request.approvals.length > (numberSupporters/2), "Not enough approvals");
    ...
    function isApproved(Request storage request, address approver) internal view returns (bool) {
